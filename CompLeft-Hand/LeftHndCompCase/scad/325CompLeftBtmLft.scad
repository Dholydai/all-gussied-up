...
//What a mess 06 July 2024
//TXT
translate([110.7,61,0])
rotate([0,0,90])
linear_extrude(3)
text("LeftC-Lft",size=10,font="Microsoft Sans Serif");
translate([60.5,77,0])
rotate([0,0,90])
linear_extrude(3)
...
translate([142,12.3,2.2])
    cylinder(h=7,r1=3,r2=3);
//Mid Supports
translate([68,50,2.2])
    cylinder(h=7,r1=3,r2=3);
translate([68,137,2.2])
    cylinder(h=7,r1=3,r2=3);
//PCB Side
...
translate([34,6.5,9.2])
    cube([13,3,2]);
translate([102,6.5,2.2])
    cube([13,6,7]);
translate([102,6.5,9.2])
    cube([13,3,2]);
//PCB Top Left
...
translate([10.7,126,9.2])
    cube([3,13,2]);
//PCB Bottom Left
translate([147.5,42,2.2])
    cube([6,8,7]);
translate([150.5,42,9.2])
    cube([3,8,2]);
translate([128.5,104,2.2])
    cube([6,13,7]);
translate([131.5,104,9.2])
    cube([3,13,2]);
//Mechanical Union
//Top Joint
difference() {
