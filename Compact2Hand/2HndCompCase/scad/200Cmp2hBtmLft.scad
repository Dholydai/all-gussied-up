...
translate([20,120,2.2])
    cube([122,2,4]);
//Corner Supports
translate([16.9,13,2.2])
    cylinder(h=7,r1=3,r2=3);
translate([128.4,12,2.2])
    cylinder(h=7,r1=3,r2=3);
//Mid Supports
translate([68,50,2.2])
    cylinder(h=7,r1=3,r2=3);
...
translate([92,6.6,9.2])
    cube([13,3,2]);
//PCB Top Left
translate([10.9,64,2.2])
    cube([6,13,7]);
translate([10.9,64,9.2])
    cube([3,13,2]);
translate([10.9,126,2.2])
    cube([6,13,7]);
translate([10.9,126,9.2])
    cube([3,13,2]);
//PCB Bottom Left
translate([128.3,67.5,2.2])
    cube([6,8,7]);
translate([131.3,67.5,9.2])
    cube([3,8,2]);
translate([128.3,120,2.2])
    cube([6,13,7]);
translate([131.3,120,9.2])
    cube([3,13,2]);
//Mechanical Union
//Top Joint
difference() {
    translate([16.2,139.7,2.2])
        difference() {
            union() {   
                translate([10,14,0])
                    cube([11,9,6]);
