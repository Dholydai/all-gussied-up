...
translate([11,64,9.2])
    cube([3,13,2]);
translate([11,126,2.2])
    cube([6,13,7]);
translate([11,126,9.2])
    cube([3,13,2]);
//PCB Bottom Left
translate([128.4,67.5,2.2])
    cube([6,8,7]);
translate([131.4,67.5,9.2])
    cube([3,8,2]);
translate([128.4,120,2.2])
    cube([6,13,7]);
translate([131.4,120,9.2])
    cube([3,13,2]);
//Mechanical Union
//Top Joint
difference() {
    translate([16.3,139.5,2.2])
        difference() {
            union() {   
                translate([10,14,0])
                    cube([11,9,6]);
