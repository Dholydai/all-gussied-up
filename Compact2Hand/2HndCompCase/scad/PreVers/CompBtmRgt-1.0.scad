...
translate([105,6.6,9.2])
    cube([13,3,2]);
//PCB Bottom Right
translate([8.4,26.5,2.2])
    cube([6,8,7]);
translate([8.4,26.5,9.2])
    cube([3,8,2]);
translate([27.4,109,2.2])
    cube([6,13,7]);
translate([27.4,109,9.2])
    cube([3,13,2]);
//PCB Top Right
translate([144.8,59,2.2])
    cube([6,13,7]);
translate([147.8,59,9.2])
    cube([3,13,2]);
translate([144.8,122,2.2])
    cube([6,13,7]);
translate([147.8,122,9.2])
    cube([3,13,2]);
//Mechanical Union
//Bottom Joint
translate([18,139.5,2.2])
    difference() {
        union() {   
            translate([10,14,0])
                cube([11,9,6]);
