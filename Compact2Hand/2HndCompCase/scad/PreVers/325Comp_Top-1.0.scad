//Modified by Dholydai on 16 June 2024
// Generated by SolidPython 1.1.3 on 2024-06-03 01:27:26
$fn = 32;
...
translate([119.5,7,13])
    cylinder(d=4,h=5);
    //Aft Left Screw Hole
translate([128,154.35,13])
    cylinder(d=4,h=5);
//Stagger Hole Shifted 9.525mm Right
translate([154.625,35.5,15])
cube([15.6,14.1,7]);
}
//Front Left Patch
translate([110.6,7,15.89])
    cylinder(d=4,h=1.11);
//Aft Left Patch
translate([110.6,154.35,15.89])
    cylinder(d=4,h=1.11);
//Stagger Patch
...
}n_string = '({})'.format(option_string) if option_string else ''
...
def main():
    ...
    parser.add_argument('-i', '--input-file', metavar = 'layout_json_file_name.json', help = 'A path to //USB Port
translate([-5,74,0])
minkowski()
{cube([12.5,12.5,7]);
        sphere(d=3);
    }
}a keyboard layout editor json file', required = True, action=CheckExt({'json'}))
