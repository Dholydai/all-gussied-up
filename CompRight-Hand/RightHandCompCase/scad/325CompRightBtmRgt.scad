...
translate([20,125,2.2])
    cube([122,2,4]);
//Corner Supports
translate([14.9,13.3,2.2])
    cylinder(h=7,r1=3,r2=3);
translate([145.4,13.3,2.2])
    cylinder(h=7,r1=3,r2=3);
//Mid Supports
translate([93,138,2.2])
    cylinder(h=7,r1=3,r2=3);
translate([93,72,2.2])
    cylinder(h=7,r1=3,r2=3);
//PCB Side
translate([45,6.5,2.2])
    cube([13,6,7]);
translate([45,6.5,9.2])
    cube([13,3,2]);
...
translate([105,6.5,9.2])
    cube([13,3,2]);
//PCB Bottom Right
translate([8.1,26.5,2.2])
    cube([6,8,7]);
translate([8.1,26.5,9.2])
    cube([3,8,2]);
translate([27.1,109,2.2])
    cube([6,13,7]);
translate([27.1,109,9.2])
    cube([3,13,2]);
//PCB Top Right
